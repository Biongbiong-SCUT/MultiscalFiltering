...
#include "Algorithms/RollingGuidedNormalFiltering.h"
...
public:
    ...
    enum AlgorithmsType{kNon, kNoise, kBilateralMeshDenoising, kNonIterativeFeaturePreservingMeshFiltering,
                       ...
                       kMeshDenoisingViaL0Minimization, kGuidedMeshNormalFiltering, kRollingGuidedNormalFiltering, kMyBilateralFiltering, kMSFitering};
