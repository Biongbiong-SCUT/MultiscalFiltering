...
private slots:
    ...
    //add
    void ShowFiltereNormal(bool _val);
	void ImportMeshOriginal();
    ...
    void ShowRollingGuidedNormalFilteringWidget();

	void ShowMyBilateralFiltering();
...
private:
    ...
    /**/
    QAction *action_rolling_guided_normal_filtering_;
	QAction *action_my_bilatering_mesh_denoisying_;
    ...
    //add
    QAction *action_render_normals_;
    QAction *action_render_filtered_normals_;
	QAction *action_compare_with_mesh_;
	QAction *action_load_original_mesh_;
